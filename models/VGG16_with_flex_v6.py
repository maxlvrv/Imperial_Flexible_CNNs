...
class FlexiLayer2(nn.Conv2d):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
        ...
        self.threshold1 = nn.parameter.Parameter(torch.randn((100, 128, 28, 28)), requires_grad=True)
...
class FlexiLayer3(nn.Conv2d):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
        ...
        self.threshold1 = nn.parameter.Parameter(torch.randn((100, 256, 12, 12)), requires_grad=True)
    ...
    # ================================================= Flexible Layer Block4(1) ================================================================================
class FlexiLayer4_1(nn.Conv2d):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 padding=0, dilation=1, groups=1,
                 bias=True, padding_mode='zeros'):
        kernel_size = kernel_size
        ...
        padding = padding
        dilation = dilation
        super(FlexiLayer4_1, self).__init__(
            in_channels, out_channels, kernel_size, stride, padding, dilation,
            groups, bias, padding_mode)
...
class VGG16(nn.Module):
  def __init__(self):
    ...
    self.block1 = nn.Sequential(
                  ...
                  nn.BatchNorm2d(64),
                  nn.ReLU(),
                  FlexiLayer1(in_channels = 64,out_channels = 64,kernel_size = 3, padding =1),
                  nn.BatchNorm2d(64),
                  nn.ReLU(),
    ...
    self.block2 = nn.Sequential(
                  ...
                  nn.BatchNorm2d(128),
                  nn.ReLU(),
                  FlexiLayer2(in_channels = 128,out_channels = 128,kernel_size = 3, padding =1),
                  nn.BatchNorm2d(128),
                  nn.ReLU(),
                  nn.MaxPool2d(kernel_size=2, stride=2),
                  nn.Dropout2d(0.4))
    ...
    self.block4 = nn.Sequential(
                  ...
                  nn.BatchNorm2d(512),
                  nn.ReLU(),
                  FlexiLayer4_1(in_channels = 512,out_channels = 512,kernel_size = 3,padding = 1),
                  nn.BatchNorm2d(512),
                  nn.ReLU(),
                  FlexiLayer4_2(in_channels = 512,out_channels = 512,kernel_size = 3, padding =1),
                  nn.BatchNorm2d(512),
                  nn.ReLU(),
                  #nn.MaxPool2d(kernel_size=2, stride=2) ,
                  nn.Dropout2d(0.4))
